...
const OrganizerApprovalCard = ({ approval }) => {
    ...
    const removeApproval = async () => {
        setLoadingMessage("Deleting approval, please wait....")
        setLoading(true)
        try {
        ...
        loading ? <Loader message={loadingMessage} /> :
            <>
                ...
                {popup === `trackapproval-${approval._id}` && (
                    <PopupScreen>
                        <div
                            className={`max-h-[85%] overflow-y-auto rounded-lg mx-auto p-4 w-[90%] sm:w-[70%] lg:w-[40%] flex flex-col gap-8 font-lato mt-12 sm:mt-20 ${currentTheme === "light"
                                ? "text-black bg-white"
                                : "text-white bg-gray"
                                }`}
                        >
                ...
                {popup === `viewapproval-${approval._id}` && (
                    <PopupScreen>
                        <div
                            className={`max-h-[90%] lg:max-h-[85%] overflow-y-auto rounded-lg mx-auto p-4 w-[92%] sm:w-[85%] lg:w-[50%] flex flex-col gap-8 font-lato mt-12 sm:mt-20 ${currentTheme === "light"
                                ? "text-black bg-white"
                                : "text-white bg-gray"
                                }`}
                        >
